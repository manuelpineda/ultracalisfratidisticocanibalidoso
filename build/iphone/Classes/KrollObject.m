 ...
 * Copyright (c) 2009-2011 by ultra, Inc. All Rights Reserved.
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ultraObject class]])
		{
			for (NSString *key in [[(ultraObject*)o modules] allKeys])
			{
