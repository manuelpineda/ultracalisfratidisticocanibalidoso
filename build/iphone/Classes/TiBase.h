...
// in simulator we redefine to format for ultra Developer console
...
{\
	NSString * exceptionName = [@"org.ultra." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ultra";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIultraNativeItemNone = -1, 
	UIultraNativeItemSpinner = -2,
	UIultraNativeItemProgressBar = -3,
	
	UIultraNativeItemSlider = -4,
	UIultraNativeItemSwitch = -5,
	UIultraNativeItemMultiButton = -6,
	UIultraNativeItemSegmented = -7,
	
	UIultraNativeItemTextView = -8,
	UIultraNativeItemTextField = -9,
	UIultraNativeItemSearchBar = -10,
	
	UIultraNativeItemPicker = -11,
	UIultraNativeItemDatePicker = -12,
	
	UIultraNativeItemInfoLight = -13,
	UIultraNativeItemInfoDark = -14,
	
	UIultraNativeItemDisclosure = -15,
	
	UIultraNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ultra instances of
